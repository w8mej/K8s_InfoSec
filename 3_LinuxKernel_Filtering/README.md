...
## Custom Seccomp policies.  Traditionally, Seccomp policies are written in eBPF.  However, there exists features and tooling which will allow one to write in JSON.  
### What do I need?
...
## Here is the walkthrough of the policy
{
